...
{
    private const string AviationWeatherBaseUrl = "https://aviationweather.gov/api/data/metar";
    ...
    {
        var url = $"{AviationWeatherBaseUrl}?ids={Uri.EscapeDataString(icao)}&format=raw";
